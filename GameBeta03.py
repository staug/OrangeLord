...
def save_game():
    ...
    file = shelve.open('savegame.db', 'n')
    file['map'] = worldmap
...
def load_game():
    ...
    file = shelve.open('savegame.db', 'r')
    worldmap = file['map']
...
def system_init():
    ...
    pygame.display.set_caption('Orange Lord Game v0.3')
...
def main_menu():
    ...
    while True:
        ...
        choice = menu('Orange', ['Play a new game', 'Continue last game', 'Quit'], 500)
