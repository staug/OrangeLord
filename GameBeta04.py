...
def new_game():
    ...
    for i in range(1,GAME_NB_MONSTER+1):
        ...
        fighter_component = Fighter(hp=10, defense=0, power=3, death_function = getattr(__main__,"monster_death"))
    ...
    for i in range(GAME_NB_MONSTER+1, 2*(GAME_NB_MONSTER+1)):
        ...
        item_component = Item(use_function=getattr(__main__,config.get(item_name, 'function')))
