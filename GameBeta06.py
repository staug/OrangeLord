    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN:
                ...
                for object in worldobjects:
                    if object.fighter and not object == player and (max_range is None or player.distance(tilex, tiley) <= max_range) and object.x == tilex and object.y == tiley and worldmap.getTileAt(tilex, tiley).isVisible():
                        return object
